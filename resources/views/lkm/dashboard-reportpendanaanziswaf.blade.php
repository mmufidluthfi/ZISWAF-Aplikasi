				...
				<nav>
					<ul>
						...
						<ul class="submenu">
							...
							<li class="section"><a href="{{ url('/lkm/dashboard-reportpendanaanziswaf/')}}/{{ Auth::user()->id }}">Laporan Pendanaan Lembaga</a></li>
							</ul>
						</li>
					</ul>
				</nav>
								...
								<thead>
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="{{ URL::to('/lkm/detail_laporan_ziswaf/'.$rc->id_laporan_z)}}"><button>Lihat</button></a></td>
