	...
	@elseif (Auth::user()->admin==4)
      ...
      <section class="wrapper">
		  <div class="container">
			<div class="row">
				<div class="col-lg-9">
					<h3 class="page-header"><i class="fa fa-user-md"></i> Manajemen Akun Lembaga</h3>
						<ol class="breadcrumb">
								...
								<div class="widget-content">
									<div class="tabbable">
										<ul class="nav nav-tabs">
										  <li>
										    <a href="#formcontrols1" data-toggle="tab">Pendaftaran Akun Lembaga</a>
										  </li>
										  <li class="active">
										    <a href="#jscontrols1" data-toggle="tab">List Lemabaga ZISWAF</a>
										  </li>
										</ul>
